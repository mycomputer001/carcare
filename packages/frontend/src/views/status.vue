<template>
  ...
  <div class="min-h-screen w-full">
    ...
    <div class="ring-black ring-2 mx-10 mt-5 rounded grid grid-cols-4 p-2">
      ...
      <div class="row-span-2 font-bold text-6xl text-orange-500">
        13:00 น.
      </div>
      ...
      <div class="col-span-4 flex justify-center gap-3">
        <router-link to="/firstpage" class="text-right bg-main px-2 text-2xl font-bold rounded-lg hover:bg-orange-600">
          ยกเลิก
        </router-link>
